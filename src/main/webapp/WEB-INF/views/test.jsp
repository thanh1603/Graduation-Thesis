<!DOCTYPE html> <!--[if IE]><![endif]--> <!--[if IE 8 ]> <html dir="ltr" lang="vi" class="ie8"><![endif]--> <!--[if IE 9 ]> <html dir="ltr" lang="vi" class="ie9"><![endif]--> <!--[if (gt IE 9)|!(IE)]><!-->
...
<head>
    ...
    <base href="http://ggffg.myzozo.net/"/>
    <link rel="dns-prefetch" href="//fonts.googleapis.com"/> <!-- START STYLE -->
    <link rel="stylesheet" type="text/css"
          href="catalog/view/theme/freshfood/stylesheet/stylesheet.min.css?v=1554609311" data-minify="1"/>
    <script type="text/javascript"
            src="catalog/view/theme/freshfood/javascript/jquery-3.3.1.min.js?v=1554609311"></script>
    <link href="http://ggffg.myzozo.net/image/catalog/logo/fav.png" rel="icon"/>
    <link rel="stylesheet" type="text/css"
          href="catalog/view/theme/freshfood/stylesheet_custom/stylesheet.css?v=1554609311"/>
</head>
...
<header class="header">
    <div class="topbar-mobile hidden-lg hidden-md text-center text-md-left">
        <div class="container"><span class="language mobi_lang_curr"></span> <span class="currency mobi_lang_curr"> <a
                ...
                class="form-currency"> <input type="hidden" name="code" value=""/> <input type="hidden" name="redirect"
                                                                                          value="http://ggffg.myzozo.net/checkout/checkout"/> </form> </span>
        </div>
    </div>
                            ...
                            <li class="currency desk_lang_curr"><a class="dropdown-toggle" data-toggle="dropdown"
                                ...
                                <form action="http://ggffg.myzozo.net/common/currency/currency" method="post"
                                    ...
                                    <input type="hidden" name="redirect"
                                           value="http://ggffg.myzozo.net/checkout/checkout"/></form>
                            </li>
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-3 text-lg-left">
                    <div class="logo inline-block" id="logo"><a href="http://ggffg.myzozo.net/" class="logo-wrapper">
                        <img src="http://ggffg.myzozo.net/image/catalog/logo/logo_small-1.png" alt="Fresh Food"/> </a>
                    </div>
                </div>
                                ...
                                <ul id="cart-sidebar" class="mini-products-list count_li">
                                        ...
                                        <ul>
                                            <li class="item productid-17898181">
                                                <div class="border_list"><a class="product-image"
                                                                            ...
                                                                            title="Kiwi xanh"> <img alt="Kiwi xanh"
                                                    ...
                                                    <div class="detail-item">
                                                        <div class="product-details"><p class="product-name"><a
                                                                href="http://ggffg.myzozo.net/kiwi-xanh"
                                                                title="Kiwi xanh">Kiwi xanh</a></p></div>
                                                        <div class="product-details-bottom"><span
                                                                class="price">119,000đ</span> <a
                                                                href="javascript:void(0);" onclick="cart.remove('939');"
                                                                title="Xóa"
                                    ...
                                    <li class="pd">
                                        <div class="top-subtotal">
                                            <div class="clearfix"> Thành tiền: <span class="price">119,000đ</span></div>
                                            <div class="clearfix"> Phí giao hàng tận nơi: <span class="price">0đ</span>
                                            </div>
                                            <div class="clearfix"> Tổng số: <span class="price">119,000đ</span></div>
                                        </div>
                                    </li>
        ...
        <div class="menu-bar hidden-md hidden-lg"><img src="/catalog/view/theme/freshfood/image/menu-bar.png"
                                                       alt="menu bar"/></div>
        <div class="icon-cart-mobile hidden-md hidden-lg f-left absolute"
            ...
            <div class="icon relative"><i class="fa fa-shopping-bag"></i> <span class="cartCount count_item_pr">0</span>
            </div>
        </div>
    </div>
    <nav>
            ...
            <div class="col-xs-12">
                <ul class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                    <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item"
                        ...
                        <span itemprop="name"><i class="fa fa-home"></i></span> </a> <span><i
                            class="fa fa-angle-right"></i></span>
                        <meta itemprop="position" content="1"/>
                    </li>
                    <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item"
                                                                                                      href="http://ggffg.myzozo.net/checkout/checkout">
                        <strong itemprop="name">Thanh toán</strong> </a>
...
<section class="page">
    <div class="policy d-flex justify-content-around " id="header_services-0" style="background-image: none;">
        <div class="item-policy d-flex align-items-center" style="width:"><a href="javascript:void(0)"> <img
                src="http://ggffg.myzozo.net/image/cache/catalog/services/policy1-0x0.png" alt="Miễn phí vận chuyển"
                class="fa"/> </a>
            <div class="info a-left"><a href="javascript:void(0)"> Miễn phí vận chuyển</a>
                <p>
                <p>B&aacute;n k&iacute;nh 100 km</p></p> </div>
        </div>
        <div class="item-policy d-flex align-items-center" style="width:"><a href="javascript:void(0)"> <img
                src="http://ggffg.myzozo.net/image/cache/catalog/services/policy2-0x0.png" alt=" Hỗ trợ 24/7"
                class="fa"/> </a>
            <div class="info a-left"><a href="javascript:void(0)"> Hỗ trợ 24/7</a>
                <p>
                <p>Hotline:&nbsp;<a href="callto:19001009">0123456789</a></p></p> </div>
        </div>
        <div class="item-policy d-flex align-items-center" style="width:"><a href="javascript:void(0)"> <img
                src="http://ggffg.myzozo.net/image/cache/catalog/services/policy3-0x0.png" alt="Giờ làm việc"
                class="fa"/> </a>
            <div class="info a-left"><a href="javascript:void(0)"> Giờ làm việc</a>
                <p>
                <p>T2 - T7 Giờ h&agrave;nh ch&iacute;nh</p></p> </div>
        </div>
    </div>
                        ...
                        <div class="col-sm-8">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body"> <!-- Apply for VN -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group required"><label class="control-label col-md-4"
                                                ...
                                                tiết</label>
                                                <div class="col-sm-8"><input type="text" name="address_1" value=""
                                                                             id="input-address"
                                    ...
                                    <div id="container-form-address-ship"><h4>Thông tin thanh toán</h4>
                                        <!-- Apply for VN -->
                                        <div class="form-group required"><label class="control-label col-md-2"
                                                                                for="input-payment-firstname">Tên đầy
                                            đủ</label>
                                            <div class="col-sm-10"><input type="text" name="payment_firstname"
                                                                          id="input-payment-firstname" value=""
                                        ...
                                        <div class="form-group required"><label class="control-label col-md-2"
                                            ...
                                            <div class="col-md-4"><span id="load-ajax-payment-zone"> <select
                                                    ...
                                                    class="form-control"></select> </span></div>
                                        </div>
                                        <div class="form-group required"><label class="control-label col-md-2"
                                                                                for="input-payment-address">Địa chỉ chi
                                            tiết</label>
                                            <div class="col-sm-10"><input type="text" name="payment_address_1" value=""
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="adr-oms checkbox"><input type="checkbox"
                                                                                     name="update_address"
                                                                                     id="update-address" checked/>&nbsp;&nbsp;<label
                                        ...
                                        <div class="adr-oms radio select-method"><input type="radio"
                                            ...
                                            <div class="adr-oms payment-method">
                                                <div class="thumbnail"><img alt="Chuyển khoản"
                                                                            src="catalog/view/theme/default/image/payment/bank_transfer.png"/>
                                                </div>
                                            ...
                                            <div class="payment-method-toggle box-installment installment-disabled"
                                                ...
                                                <div class="disabled-cod-body">Thông tin thanh toán</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="group">
                                        <div class="adr-oms radio select-method"><input type="radio"
                                            ...
                                            <div class="adr-oms payment-method">
                                                <div class="thumbnail"><img alt="Thu tiền tại nhà (COD)"
                                                                            src="catalog/view/theme/default/image/payment/cod.png"/>
                                                </div>
                                                <div class="description">
                                ...
                                <div class="panel-body" id="container-form-invoice">
                                    <div class="form-group"><label class="control-label col-md-2" for="input-taxcode">Mã
                                        ...
                                        <div class="col-sm-10"><input type="text" name="tax_code" id="input-taxcode"
                                                                      value="" placeholder="Ví dụ: 398473094385"
                                                                      class="form-control"/></div>
                                    </div>
                                    <div class="form-group"><label class="control-label col-md-2" for="input-company">Tên
                                        ...
                                        <div class="col-sm-10"><input type="text" name="company" id="input-company"
                                                                      value="" placeholder="Ví dụ: Công ty Cổ phần ASIA"
                                                                      class="form-control"/></div>
                                    </div>
                                    <div class="form-group"><label class="control-label col-md-2"
                                        ...
                                        <div class="col-sm-10"><input type="text" name="company_address"
                                                                      id="input-company-address" value=""
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-default">
                                <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-shopping-cart"
                                                                                      aria-hidden="true"></i> Đơn
                                    hàng</strong> (1 sản phẩm) </h3></div>
                                                ...
                                                <div class="table_order_items-cell-detail">
                                                    <div class="table_order_items-cell-title">
                                                        <div class="table_order_items_product_name"><a target="_blank"
                                                                                                       ...
                                                                                                       href="http://ggffg.myzozo.net/kiwi-xanh"
                                                                                                       title="Kiwi xanh">
                                                            <span class="title">Kiwi xanh</span> </a></div>
                                                    </div>
                                                </div>
                                                <div class="table_order_items-cell-price">
                                                    <div class="tt-price">119,000đ</div>
                            ...
                            <div class="text-center"><a class="pull-left" href="http://ggffg.myzozo.net/checkout/cart"
            ...
            <section class="awe-section-12 carousel_partner module_carousel " id="carousel-0">
                <div class="section section-brand mb-5">
                    <div class="container"><h2 class="hidden">Partner</h2>
                        <div class="owl-carousel owl-theme" data-nav="true" data-lg-items="6" data-md-items="6"
                             data-sm-items="2" data-xs-items="2">
                            <div class="brand-item"><a href="javascript:void(0)" class="img25"> <img
                                    src="http://ggffg.myzozo.net/image/cache/catalog/hang-san-xuat/brand1-165x80.png"
                                    alt="brand 1"/> </a></div>
                            <div class="brand-item"><a href="javascript:void(0)" class="img25"> <img
                                    src="http://ggffg.myzozo.net/image/cache/catalog/hang-san-xuat/brand2-165x80.png"
                                    alt="brand 2"/> </a></div>
                            <div class="brand-item"><a href="javascript:void(0)" class="img25"> <img
                                    src="http://ggffg.myzozo.net/image/cache/catalog/hang-san-xuat/brand3-165x80.png"
                                    alt="brand 3"/> </a></div>
                            <div class="brand-item"><a href="javascript:void(0)" class="img25"> <img
                                    src="http://ggffg.myzozo.net/image/cache/catalog/hang-san-xuat/brand4-165x80.png"
                                    alt="brand 4"/> </a></div>
                            <div class="brand-item"><a href="javascript:void(0)" class="img25"> <img
                                    src="http://ggffg.myzozo.net/image/cache/catalog/hang-san-xuat/brand5-165x80.png"
                                    alt="brand 5"/> </a></div>
                            <div class="brand-item"><a href="javascript:void(0)" class="img25"> <img
                                    src="http://ggffg.myzozo.net/image/cache/catalog/hang-san-xuat/brand6-165x80.png"
                                    alt="brand 6"/> </a></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="copyright clearfix">
                <div class="container">
                    <div class="inner clearfix">
                        <div class="row">
                            <div class="col-md-6 text-center text-lg-left"><span>&copy; Copyright 2019 Fresh Food. Thiết kế bởi <a
                                    target="_blank"
...
<link href="https://fonts.googleapis.com/css?family=Roboto:300,300i,400,400i,500,500i,700,700i&amp;subset=vietnamese"
      rel="stylesheet">
<script type="text/javascript" src="catalog/view/theme/freshfood/javascript/zozo-main.min.js?v=1554609311"></script>
<link rel="stylesheet" href="catalog/view/theme/default/stylesheet/social_login_button.css"/> <!-- Facebook Login -->
<!-- Google Login --> <!-- Facebook script -->
<div id="fb-root"></div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="/checkout/checkout" class="btn btn-primary">Tiến hành thanh toán</a></div>
        </div>
    </div>
</div>
