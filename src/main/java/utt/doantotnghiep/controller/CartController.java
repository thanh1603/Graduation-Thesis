...
import utt.doantotnghiep.service.*;
import utt.doantotnghiep.service.*;
...
public class CartController extends BaseController {
     ...
     * @param response
     */
    @RequestMapping(value = {"/cart/{userID}/{orderCode}/print"}, method = RequestMethod.GET)
...
//            Result result = this.iOrderService.printOrder("linh12@gmail.com", orderCode );
            ...
            // Kieu dua ve la dang inline -> no se view duoc
    ...
    public  void printOrderCustomer(@PathVariable(value = "orderCode") String orderCode,
                            HttpServletResponse response) {
        try{
            // this.userCurrent().getEmail() lay ra email cua user dang dang nhap
