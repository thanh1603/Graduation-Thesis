...
<div class="container" style="margin-top: 20px;">
	<div class="row">
		...
		<div id="content" class="col-sm-12 col-xs-12 col-md-12">
			<div class="row">
				<form method="post" action="" name="checkout_form"
					id="checkout_form" enctype="multipart/form-data"
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div class="form-group required">
									<label class="control-label col-md-2" for="input-firstname">Tên
										đầy đủ</label>
									<div class="col-sm-10">
										...
										<div class="form-group required">
											...
											<div class="col-sm-8">
												<input type="text" name="telephone" id="input-telephone"
													value="" placeholder="Ví dụ: 01234567890"
													class="form-control" />
											</div>
										</div>
									</div>
								...
								<div class="form-group">
									<label class="control-label col-md-2" id="label-zone">Lời
										nhắn</label>
									<div class="col-sm-10">
										<textarea name="comment" id="input-comment" rows="3"
											class="form-control"
					...
					<div class="col-md-4">
										...
										<span id="ajax-load-shipping-method">
											...
											<div class="radio">
												<label> <input type="radio" name="shipping_method"
													onclick="updateFee()" value="geo.geo" checked /> Phí giao
													hàng tận nơi - 0đ
												</label>
											</div>
										</span>
						...
						<div class="text-center">
							...
							<button class="btn btn-primary pull-right" type="button"
								...
								onclick="$('form#checkout_form').submit();">
		...
		<div class="clearfix"></div>
		<section class="awe-section-12 carousel_partner module_carousel "
			id="carousel-0"></section>
	</div>
</div>
