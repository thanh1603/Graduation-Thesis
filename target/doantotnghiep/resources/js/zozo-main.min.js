window.Zozoweb || (window.Zozoweb = {}), Zozoweb.mediaDomainName = "//zozoweb.dktcdn.net/", Zozoweb.each = function (a, b) {
    ...
    function f(a, b, c, d) {
        ...
        a = a.toFixed(b);
        var e = a.split("."), f = e[0].replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1" + c), g = e[1] ? d + e[1] : "";
        return f + g
    }
    ...
    return a.prototype.replaceSelector = function (a) {
        ...
        var c = this.selectorDivClass, d = this.product.optionNames(), e = Zozoweb.map(this.selectors, function (a) {
        ...
        var a = {initialLoad: !0}, b = this.selectVariantFromDropdown(a);
        if (!b) {
            var c = this;
            setTimeout(function () {
...
Zozoweb.money_format = "${{amount}}", Zozoweb.onError = function (XMLHttpRequest, textStatus) {
    ...
    }); else for (var o in t) Zozoweb.buildParams(o, t[o], e);
...
(function (a) {
    ...
    function l(b, c, d, e, f, g) {
        var h = Sb(b), i = h.length, j = Sb(c), k = j.length;
        if (i !== k && !e) return !1;
        for (var l, m = i; m--;) if (l = h[m], !(e ? l in c : Pb.call(c, l))) return !1;
        for (var n = e; ++m < i;) {
            l = h[m];
            var o, p = b[l], q = c[l];
    ...
    function s(a, b, c, d, e, f) {
        var g = Ub(a), h = Ub(b), i = rb, j = rb;
        g || (i = Qb.call(a), i === qb ? i = yb : i !== yb && (g = p(a))), h || (j = Qb.call(b), j === qb && (j = yb));
        var k = i === yb && !Tb(a), n = j === yb && !Tb(b), o = i === j;
        if (o && !g && !k) return m(a, b, i);
        if (!d) {
            var q = k && Pb.call(a, "__wrapped__"), s = n && Pb.call(b, "__wrapped__");
    ...
    function ia(a, b, c) {
        var d = new _b, e = Object.prototype.toString.call(a);
        if (ga(a) || "[object HTMLCollection]" === e) for (var f = 0, g = a.length; g > f; f++) d.add(ia(a.item(f), b, c)); else a && d.add(new ha(a, b, c));
        return d
    }
    ...
    function la(a) {
        var b = this;
        return new xg(function (c) {
            var d = new Bg, e = new _b, f = new lc(e);
    ...
    function ma(a) {
        ...
        return new xg(function (c) {
            ...
            var e = new ic, f = new _b(e), g = new lc(f), h = new Bg;
    ...
    function xa(a, b, c) {
        return new xg(function (d) {
            var e, f = !1, g = new ic, h = null, i = [], j = !1;
    ...
    function Aa(a, b) {
        return new xg(function (c) {
            var d, e = !1, f = new ic, g = 0, h = a.subscribe(function (a) {
                var h = $a(b)(a);
    ...
    function Ba(a, b, c, d) {
        return Ya(b) && (d = c, c = b, b = sd()), Sc.isObservable(d) || (d = yd(new _f)), new xg(function (e) {
            ...
            var h = new ic, i = new ic, j = new hc;
            h.setDisposable(j);
            var k = 0, l = !1;
    ...
    function Ca(a, b, c, d) {
        return pc(c) && (d = c, c = yd(new _f)), c instanceof Error && (c = yd(c)), pc(d) || (d = Bc), Sc.isObservable(c) || (c = yd(new _f)), new xg(function (e) {
            ...
            var g = 0, h = new hc, i = new ic, j = !1, k = new ic;
    ...
    var Ha = {"function": !0, object: !0}, Ia = Ha[typeof exports] && exports && !exports.nodeType ? exports : null,
        Ja = Ha[typeof module] && module && !module.nodeType ? module : null,
        Ka = b(Ia && Ja && "object" == typeof global && global), La = b(Ha[typeof self] && self),
        Ma = b(Ha[typeof window] && window), Na = Ja && Ja.exports === Ia ? Ia : null, Oa = b(Ha[typeof this] && this),
        Pa = Ka || Ma !== (Oa && Oa.window) && Ma || La || Oa || Function("return this")(),
        Qa = {internals: {}, config: {Promise: Pa.Promise}, helpers: {}}, Ra = Qa.helpers.noop = function () {
        }, Sa = Qa.helpers.identity = function (a) {
            return a
        }, Ta = Qa.helpers.defaultNow = Date.now, Ua = Qa.helpers.defaultComparer = function (a, b) {
            return Vb(a, b)
        ...
        }(), Za = {e: {}}, $a = Qa.internals.tryCatch = function (a) {
            if (!Ya(a)) throw new TypeError("fn must be a function");
            return d(a)
        };
    Qa.config.longStackSupport = !1;
    var _a = !1, ab = $a(function () {
        throw new Error
    })();
    _a = !!ab.e && !!ab.e.stack;
    var bb, cb = j(), db = "From previous event:", eb = Qa.EmptyError = function () {
    ...
    var lb = Qa.doneEnumerator = {done: !0, value: a}, mb = Qa.helpers.isIterable = function (b) {
        return b && b[kb] !== a
    ...
    var ob = Qa.internals.bindCallback = function (a, b, c) {
        ...
        qb = (pb.length, "[object Arguments]"), rb = "[object Array]", sb = "[object Boolean]", tb = "[object Date]",
        ub = "[object Error]", vb = "[object Function]", wb = "[object Map]", xb = "[object Number]",
        yb = "[object Object]", zb = "[object RegExp]", Ab = "[object Set]", Bb = "[object String]",
        Cb = "[object WeakMap]", Db = "[object ArrayBuffer]", Eb = "[object Float32Array]",
        Fb = "[object Float64Array]", Gb = "[object Int8Array]", Hb = "[object Int16Array]", Ib = "[object Int32Array]",
        Jb = "[object Uint8Array]", Kb = "[object Uint8ClampedArray]", Lb = "[object Uint16Array]",
        Mb = "[object Uint32Array]", Nb = {};
    ...
    var Ob = Object.prototype, Pb = Ob.hasOwnProperty, Qb = Ob.toString, Rb = Math.pow(2, 53) - 1,
    ...
    var cc = bc.create = function (a) {
        return new bc(a)
    }, dc = bc.empty = {dispose: Ra}, ec = bc.isDisposable = function (a) {
    ...
    }(), oc = nc.normalize, pc = nc.isScheduler;
    !function (a) {
        function b(a, b) {
            function c(b) {
                function d(a, b) {
    ...
    }(nc), uc = nc.immediate = new tc, vc = function (a) {
        function b() {
            for (; d.length > 0;) {
                var a = d.dequeue();
    ...
    }(nc), wc = nc.currentThread = new vc, xc = function () {
        var a, b = Ra;
        if (Pa.setTimeout) a = Pa.setTimeout, b = Pa.clearTimeout; else {
    ...
    }(), yc = xc.setTimeout, zc = xc.clearTimeout;
    !function () {
        function a(b) {
            if (f) yc(function () {
                a(b)
        ...
        if (Ya(h)) qc = function (b) {
            ...
            var e = Pa.document.createElement("script"), f = c++;
    ...
    var Ac = function (a) {
        ...
        return Wb(b, a), d.prototype.dispose = function () {
            ...
            var e = new hc, f = qc(c(e, b, this, a));
            return new jc(e, new d(f))
        }, b.prototype._scheduleFuture = function (a, b, d) {
            if (0 === b) return this.schedule(a, d);
            var f = new hc, g = yc(c(f, d, this, a), b);
            return new jc(f, new e(g))
        }, b.prototype.scheduleLongRunning = function (a, b) {
            var c = cc(Ra);
            return qc(f(a, b, c)), c
        }, b
    }(nc), Bc = nc["default"] = nc.async = new Ac, Cc = function (a) {
        function b(b, c) {
    ...
    }(nc), Dc = Qa.Notification = function () {
        function a() {
        }
    ...
    }(Dc), Hc = Dc.createOnNext = function (a) {
        return new Ec(a)
    ...
    var Mc, Nc = Qa.internals.AbstractObserver = function (a) {
    ...
    }(Kc), Oc = Qa.AnonymousObserver = function (a) {
        function b(b, c, d) {
    ...
    }(Kc), Qc = Qa.internals.ScheduledObserver = function (a) {
        function b(b, c) {
        ...
        function b() {
            if (Qa.config.longStackSupport && _a) {
                var b = this._subscribe, c = $a(e)(new Error).e;
        ...
        function c(a, c) {
            var d = c[0], f = c[1], g = $a(f.subscribeCore).call(f, d);
        ...
        return Wb(b, a), b.prototype.subscribeCore = function (a) {
            ...
            var b = this.i++, c = $a(this.selector)(a, b, this.source);
    ...
    }(Tc), Vc = Qa.internals.Enumerable = function () {
    };
    ...
    var Wc = function (a) {
        ...
        return Wb(b, a), b.prototype.subscribeCore = function (a) {
            var b = new ic, d = {isDisposed: !1, o: a, subscription: b, e: this.sources[kb]()},
    ...
    var Xc = function (a) {
        ...
        return Wb(b, a), b.prototype.subscribeCore = function (a) {
            var b = new ic, d = {isDisposed: !1, e: this.sources[kb](), subscription: b, lastError: null, o: a},
                e = wc.scheduleRecursive(d, c);
            return new kc([b, e, new y(d)])
        }, Wb(d, Nc), d.prototype.next = function (a) {
            this._state.o.onNext(a)
    ...
    var Yc = function (a) {
        ...
        return Wb(b, a), b.prototype[kb] = function () {
            ...
            return 0 === this.l ? lb : (this.l > 0 && this.l--, {done: !1, value: this.v})
        }, b
    }(Vc), Zc = Vc.repeat = function (a, b) {
        return new Yc(a, b)
    }, $c = function (a) {
        function b(a, b, c) {
    ...
    var cd = function (a) {
        ...
        return Wb(b, a), b.prototype.subscribeCore = function (a) {
            var b = new hc, e = this, f = this._p;
            return Ya(f) && (f = $a(f)(), f === Za) ? (a.onError(f.e), b) : (f.then(function (d) {
                b.setDisposable(e._s.schedule([a, d], c))
            }, function (c) {
                b.setDisposable(e._s.schedule([a, c], d))
            }), b)
        }, b
    }(Tc), dd = Sc.fromPromise = function (a, b) {
    ...
    }(Tc), id = new hd(uc), jd = Sc.empty = function (a) {
    ...
    var md = Sc.from = function (a, b, c, d) {
    ...
    }(Tc), od = Sc.fromArray = function (a, b) {
        ...
        function c(a, b) {
            if (a.first) a.first = !1; else if (a.newState = $a(a.self._itrFn)(a.newState), a.newState === Za) return a.o.onError(a.newState.e);
    ...
    }(Tc), rd = new qd, sd = Sc.never = function () {
        return rd
    }, td = function (a) {
        function b(b, c) {
    ...
    }(Tc), xd = (Sc["return"] = Sc.just = function (a, b) {
    ...
    Sc.using = function (a, b) {
        ...
        return new xg(function (c) {
            ...
            var f, g = "L", h = "R", i = new hc, j = new hc;
            Xa(a) && (a = dd(a));
            var k = Lc(function (a) {
                d(), f === g && c.onNext(a)
            }, function (a) {
    ...
    }(Nc), Fd = Sc.combineLatest = function () {
        for (var a = arguments.length, b = new Array(a), c = 0; a > c; c++) b[c] = arguments[c];
    ...
    var Gd = function (a) {
        ...
        return Wb(b, a), b.prototype.subscribeCore = function (a) {
            var b = new ic, d = cc(Ra), e = {o: a, i: 0, subscription: b, disposable: d, sources: this._sources},
                f = uc.scheduleRecursive(e, c);
            return new kc([b, d, f])
        }, b
    }(Tc), Id = Sc.concat = function () {
        var a;
        if (Array.isArray(arguments[0])) a = arguments[0]; else {
    ...
    var Ld = Sc.merge = function () {
        ...
        if (arguments[0]) if (pc(arguments[0])) for (a = arguments[0], b = 1; d > b; b++) c.push(arguments[b]); else for (a = uc, b = 0; d > b; b++) c.push(arguments[b]); else for (a = uc, b = 1; d > b; b++) c.push(arguments[b]);
    ...
    var Pd = function (a) {
        ...
        return Wb(b, a), b.prototype.subscribeCore = function (a) {
            var b = new _b, c = new hc, d = {isStopped: !1, errors: [], o: a};
    ...
    var Rd = function (a) {
        ...
        return Wb(b, a), b.prototype.subscribeCore = function (a) {
            var b = new ic, d = {pos: 0, subscription: b, o: a, sources: this.sources}, e = uc.scheduleRecursive(d, c);
            return new jc(b, e)
        }, b
    }(Tc), Sd = function (a) {
        function b(b, c) {
    ...
    }(Nc), Td = Sc.onErrorResumeNext = function () {
        var a = [];
        if (Array.isArray(arguments[0])) a = arguments[0]; else {
            var b = arguments.length;
            a = new Array(b);
    ...
    var Xd = function (a) {
        ...
        return Wb(b, a), b.prototype.subscribeCore = function (a) {
            var b = new ic, d = this.source.subscribe(new c(a, b));
            return new jc(d, b)
        }, Wb(c, Nc), c.prototype.next = function (a) {
            var b = new hc, c = ++this.latest;
    ...
    var be = function (a) {
        ...
        return Wb(b, a), b.prototype.next = function (a) {
            if (this._q[this._i].push(a), this._q.every(c)) {
                var b = this._q.map(d), f = $a(this._p._cb).apply(null, b);
    ...
    var de = function (a) {
        ...
        return Wb(b, a), b.prototype.next = function (a) {
            if (this._s.q[this._i].push(a), this._s.q.every(c)) {
                var b = this._s.q.map(d), f = $a(this._s.cb).apply(null, b);
    ...
    var oe = function (a) {
        ...
        return Wb(c, a), c.prototype.subscribeCore = function (a) {
            var c, d = new Bg, e = new Bg, f = this._notifier(d), g = f.subscribe(e), h = this.source["@@iterator"](),
                i = {isDisposed: !1}, j = new ic, k = wc.scheduleRecursive(null, function (b, f) {
                    if (!i.isDisposed) {
                        var g = h.next();
                        if (g.done) return void (c ? a.onError(c) : a.onCompleted());
                        var k = g.value;
                        Xa(k) && (k = dd(k));
                        var l = new hc, m = new hc;
    ...
    Mc.skipLast = function (a) {
        ...
        return Id.apply(null, [od(c, a), this])
    };
    var ue = function (a) {
        function b(b, c) {
            this._o = b, this._c = c, this._q = [], a.call(this)
    ...
    Mc.takeLastBuffer = function (a) {
    ...
    }, Mc.windowWithCount = Mc.windowCount = function (a, b) {
        var c = this;
        ...
        var e = this, f = ob(a, d, 2), g = ob(b, d, 1), h = ob(c, d, 0);
    ...
    Mc.distinct = function (a, b) {
        ...
        return new xg(function (f) {
            var g = new Of, h = new _b, i = new lc(h), j = function (a) {
                return function (b) {
                    b.onError(a)
                }
            };
            return h.add(e.subscribe(function (e) {
                ...
                if (m === a && (m = new Bg, g.set(k, m), l = !0), l) {
                    var n = new Ag(k, m, i), o = new Ag(k, m), p = $a(d)(o);
    ...
    }, Mc.flatMap = Mc.selectMany = Mc.mergeMap = function (a, b, c) {
    ...
    }, Mc.flatMapLatest = Mc.switchMap = function (a, b, c) {
    ...
    var qf = Sc.spawn = function () {
        ...
        return new xg(function (d) {
            ...
            function g(a) {
                ...
                var c = X.call(b, a.value), g = null, i = !1;
    ...
    var rf = Sc.toAsync = function (a, b, c) {
        return pc(c) || (c = Bc), function () {
            var d = arguments, e = new Cg;
    ...
    }(Tc), uf = Sc.fromEventPattern = function (a, b, c) {
    ...
    var vf = function (a) {
        function b(b, c) {
            this.source = b, this.controller = new Bg, this.paused = !0, c && c.subscribe ? this.pauser = this.controller.merge(c) : this.pauser = this.controller, a.call(this)
        }

        return Wb(b, a), b.prototype._subscribe = function (a) {
            var b = this.source.publish(), c = b.subscribe(a), d = dc,
                e = this.pauser.startWith(!this.paused).distinctUntilChanged().subscribe(function (a) {
    ...
    var wf = function (b) {
        function c(a, c) {
            this.source = a, this.controller = new Bg, this.paused = !0, c && c.subscribe ? this.pauser = this.controller.merge(c) : this.pauser = this.controller, b.call(this)
        }
        ...
        return Wb(c, b), c.prototype._subscribe = function (b) {
            ...
            var d, e = [],
                f = ja(this.source, this.pauser.startWith(!this.paused).distinctUntilChanged(), function (a, b) {
    ...
    var zf = function (a) {
        ...
        var d = function (a) {
            ...
            function c(a, b) {
                return b.observable.source.request(1)
            }
            ...
            return Wb(b, a), b.prototype.completed = function () {
                ...
                this.observer.onNext(a), this.scheduleDisposable = Bc.schedule(this, c)
            }, b.dispose = function () {
    ...
    var Af = function (a) {
        ...
        function c(a, b) {
            return b.source.request(b.windowSize)
        }
        ...
        var d = function (a) {
            ...
            function c(a, b) {
                return b.observable.source.request(b.observable.windowSize)
            }
    ...
    var Df = function (a) {
    ...
    }(Tc), Ef = Qa.ConnectableObservable = function (a) {
        function b(b, c) {
        ...
        return Wb(b, a), c.prototype.dispose = function () {
            ...
            if (!this._connection) {
                if (this._subject.isStopped) return dc;
    ...
    Mc.singleInstance = function () {
        ...
        var e = this;
        return new xg(function (f) {
            var g = new _b, h = !1, i = !1, j = 0, k = 0, l = new Of, m = new Of, n = function (a) {
                f.onError(a)
            };
        ...
        return new xg(function (f) {
            ...
            var h = new _b, i = new lc(h), j = new Of, k = new Of, l = 0, m = 0, g = function (a) {
                return function (b) {
                    b.onError(a)
                }
            };
    ...
    var Jf = function (a) {
        ...
        return Wb(b, a), b.prototype._ensureActive = function (a) {
            ...
            var b = new ic, c = new _b(b), d = {q: [], m: b, d: c, activeCount: 0, isAcquired: !1, o: a};
    ...
    Mc.and = function (a) {
        ...
        return new xg(function (b) {
            var c = [], d = new Of, e = Lc(function (a) {
                b.onNext(a)
            }, function (a) {
    ...
    }(Tc), Rf = Sc.interval = function (a, b) {
    ...
    Mc.debounce = function () {
        ...
        return null == b && (d = a), pc(c) || (c = Bc), "number" == typeof b ? d = b : pc(b) && (d = a, c = b), new xg(function (b) {
            ...
            var g, h, i = d, j = a, k = [], l = new ic, m = 0;
    ...
    }, Mc.windowWithTimeOrCount = Mc.windowTimeOrCount = function (a, b, c) {
        var d = this;
        return pc(c) || (c = Bc), new xg(function (e) {
            ...
            var g = new ic, h = new _b(g), i = new lc(h), j = 0, k = 0, l = new Bg;
    ...
    }, Mc.bufferWithTime = Mc.bufferTime = function (a, b, c) {
        return this.windowWithTime(a, b, c).flatMap(O)
    }, Mc.bufferWithTimeOrCount = Mc.bufferTimeOrCount = function (a, b, c) {
    ...
    var Yf = function (a) {
        ...
        return Wb(b, a), b.prototype.subscribeCore = function (a) {
            var b = {o: a, atEnd: !1, value: null, hasValue: !1, sourceSubscription: new hc};
    ...
    var ag = function (a) {
        ...
        function c(a, b) {
            if (a.hasResult && a.o.onNext(a.result), a.first) a.first = !1; else if (a.newState = $a(a.self._itrFn)(a.newState), a.newState === Za) return a.o.onError(a.newState.e);
        ...
        return Wb(b, a), b.prototype.subscribeCore = function (a) {
            var b = {o: a, self: this, newState: this._state, first: !0, hasResult: !1};
    ...
    var ng = function (a) {
        ...
        return Wb(b, a), b.prototype.subscribeCore = function (a) {
            var b = new hc, c = new _b, d = {hasCurrent: !1, isStopped: !1, o: a, g: c};
    ...
    Mc.switchFirst = function () {
        return new ng(this)
    }, Mc.flatMapFirst = Mc.exhaustMap = function (a, b, c) {
        return new Uc(this, a, b, c).switchFirst()
    }, Mc.flatMapWithMaxConcurrent = Mc.flatMapMaxConcurrent = function (a, b, c, d) {
    ...
    Ga.prototype.then = function (b, c) {
        ...
        var e, f = this.subscriptions.length - 1, g = Qa.Observer.create(function (c) {
            var h = b(c);
    ...
    var vg = function (a) {
        ...
        return Wb(b, a), b.prototype._subscribe = function (a) {
            var b, c, d = this;
            this.subscriptions.push(new sg(this.scheduler.clock));
            for (var e = this.subscriptions.length - 1, f = new _b, g = 0, h = this.messages.length; h > g; g++) b = this.messages[g], c = b.value, function (c) {
    ...
    var xg = Qa.AnonymousObservable = function (a) {
        ...
        function c(a, c) {
            var d = c[0], f = c[1], g = $a(f.__subscribe).call(f, d);
            g !== Za || d.fail(Za.e) || e(Za.e), d.setDisposable(b(g))
        }
        ...
        return Wb(b, a), Xb(b.prototype, Kc.prototype, {
            _subscribe: function (a) {
                ...
                if (fc(this), !this.isStopped) for (var b = 0, d = c(this.observers), e = d.length; e > b; b++) d[b].onNext(a)
            }, dispose: function () {
    ...
    }(Sc), Cg = Qa.AsyncSubject = function (a) {
        function b() {
    ...
    }(Sc), Dg = Qa.BehaviorSubject = function (a) {
        function b(b) {
    ...
    }(Sc), Eg = Qa.ReplaySubject = function (a) {
        function b(a, b) {
            return cc(function () {
        ...
        return Wb(d, a), Xb(d.prototype, Kc.prototype, {
            _subscribe: function (a) {
                fc(this);
                var c = new Qc(this.scheduler, a), d = b(this, c);
    ...
    }(Sc), Fg = Qa.AnonymousSubject = function (a) {
        function b(b, c) {
...
function dl_owl() {
    $('.owl-carousel:not(.not-aweowl)').each(function () {
        ...
        if (typeof margin !== typeof undefined && margin !== !1) {
        } else {
            margin = 30
        }
        if (typeof xss_item !== typeof undefined && xss_item !== !1) {
        } else {
            xss_item = 1
        }
        if (typeof xs_item !== typeof undefined && xs_item !== !1) {
        } else {
            xs_item = 1
        }
        if (typeof sm_item !== typeof undefined && sm_item !== !1) {
        } else {
            sm_item = 3
        }
        if (typeof md_item !== typeof undefined && md_item !== !1) {
        } else {
            md_item = 3
        }
        if (typeof lg_item !== typeof undefined && lg_item !== !1) {
        } else {
            lg_item = 4
        }
        if (typeof lgg_item !== typeof undefined && lg_item !== !1) {
        } else {
            lgg_item = lg_item
        }
        if (typeof dot !== typeof undefined && dot !== !0) {
            dot = dot
        } else {
            dot = !1
        }
        if (typeof nav !== typeof undefined && nav !== !0) {
            nav = nav
        } else {
            nav = !1
        }
        $(this).owlCarousel({
            ...
            responsive: {
                0: {items: Number(xss_item), margin: 15},
                543: {items: Number(xs_item), margin: 15},
                768: {items: Number(sm_item)},
                992: {items: Number(md_item)},
                1200: {items: Number(lg_item)},
                1500: {items: Number(lgg_item)}
            }
        })
    })
}
...
function dl_countDown(selector) {
    ...
    var x = setInterval(function () {
        ...
        selector.html(days + " ngày " + hours + ":" + minutes + ":" + seconds);
        if (distance < 0) {
            clearInterval(x);
...
$(".not-dqtab").each(function (e) {
    ...
    $this1.find('.tabs-title.ajax li').click(function () {
        var $this2 = $(this), tab_id = $this2.attr('data-tab'), url = $this2.attr('data-url');
...
$('.not-dqtab .next').click(function (e) {
    ...
    var str = $(this).parent().find('.tab-titlexs').attr('data-tab'), res = str.replace("tab-", ""),
...
$('.not-dqtab .prev').click(function (e) {
    ...
    var str = $(this).parent().find('.tab-titlexs').attr('data-tab'), res = str.replace("tab-", ""),
        datasection = $(this).closest('.not-dqtab').attr('data-section'), res = Number(res);
    if (res > 1) {
        var current = res - 1
    } else {
        var current = count
...
function ajaxCarousel(selector, dataLgg) {
    $(selector + ' .owl-carousel.ajax-carousel').each(function () {
        ...
        if (typeof lgg_item !== typeof undefined && lgg_item !== !1) {
        } else {
            lgg_item = lg_item
        }
        if (typeof dot !== typeof undefined && dot !== !0) {
        ...
        $(this).owlCarousel({
            ...
            responsive: {
                ...
                543: {items: Number(xs_item), margin: 10},
                768: {items: Number(sm_item)},
                992: {items: Number(md_item)},
                1200: {items: Number(lg_item)},
                1500: {items: Number(lgg_item)}
...
!function (a) {
    ...
    a.prettyPhoto = {version: "3.1.6"}, a.fn.prettyPhoto = function (f) {
        ...
        return doresize = !0, scroll_pos = n(), a(window).unbind("resize.prettyphoto").bind("resize.prettyphoto", function () {
            ...
            "next" == a ? (currentGalleryPage++, currentGalleryPage > totalPage && (currentGalleryPage = 0)) : "previous" == a ? (currentGalleryPage--, currentGalleryPage < 0 && (currentGalleryPage = totalPage)) : currentGalleryPage = a, slide_speed = "next" == a || "previous" == a ? settings.animation_speed : 0, slide_to = currentGalleryPage * (itemsPerPage * itemWidth), $pp_gallery.find("ul").animate({left: -slide_to}, slide_speed)
