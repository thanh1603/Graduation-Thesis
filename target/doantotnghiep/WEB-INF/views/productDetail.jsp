			...
			<div class="details-product">
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-5">
						...
						<div id="gallery_01"
							class="owl-carousel owl-theme thumbnail-product"
							data-md-items="4" data-sm-items="4" data-xs-items="4"
							data-xss-items="2" data-margin="10" data-nav="true">
							<div class="item">
					...
					<div class="col-xs-12 col-sm-12 col-md-7 details-pro">
							...
							<div class="f-left margin-right-10">
								<div class="zozoweb-product-reviews-badge">
									<div class="zozoweb-product-reviews-star"
										...
										<i data-alt="1" class="star-off-png"></i>&nbsp; <i
											data-alt="2" class="star-off-png"></i>&nbsp; <i data-alt="3"
											class="star-off-png"></i>&nbsp; <i data-alt="4"
											class="star-off-png"></i>&nbsp; <i data-alt="5"
						...
						<div class="status clearfix">
							<div class="clearfix">
								Mã sản phẩm: <strong itemprop="model">${product.code}</strong>
							</div>
							<div class="clearfix">
								Tình trạng: <span class="inventory">${product.amount > 0 ? 'Còn trong kho' : 'Hết hàng'}</span>
							</div>
						</div>
						<div class="price-box clearfix">
							<div class="special-price">
								<span class="price product-price"> <fmt:formatNumber
										...
										value="${(product.price - (product.price * product.discount)/100)}" />đ
								</span>
							</div>
							<span itemprop="offers" itemscope
								itemtype="http://schema.org/Offer">
								<meta itemprop="price"
									content="${product.price - (product.price * product.discount)/100}" />
									...
									<div class="form-group form-groupx form-detail-action clearfix">
										...
										<div class="custom custom-btn-number">
											<span class="qtyminus" data-field="quantity"
												<c:if test="${product.amount != 0}">onclick="minusAmount()"</c:if>>-</span>
											...
											<span
												<c:if test="${product.amount != 0}">onclick="plusAmount()"</c:if>
												class="qtyplus" data-field="quantity">+</span>
											<form:hidden path="catalogCode"
												value="${product.catalogCode}" />
											<form:hidden path="productCode" value="${product.code}" />

										</div>
										<button type="submit"
											<c:if test="${product.amount == 0}">disabled="disabled"</c:if>
