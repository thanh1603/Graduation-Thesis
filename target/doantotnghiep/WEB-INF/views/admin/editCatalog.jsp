    ...
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            <form:form modelAttribute="catalogForm"
                       action="${pageContext.request.contextPath}/admin/catalog/update" method="post">
                <div class="form-group"><label class="control-label" for="catalogCode">
                    Mã loại sản phẩm</label>
                    <form:hidden path="code" class="form-control" id="catalogCode"/>
                    <input type="text" value="${catalogForm.code}" class="form-control" disabled="disabled">
                </div>
